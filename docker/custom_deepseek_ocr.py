...
class DeepseekOCRDummyInputsBuilder(
    ...
    def get_dummy_mm_data(
        ...
        if '<image>' in PROMPT:
            return {
                "image":
                # FIX: Added the missing prompt parameter to the tokenize_with_images call
                DeepseekOCRProcessor().tokenize_with_images(prompt=PROMPT, images = self._get_dummy_images(width=max_image_size.width,
